...
namespace Microsoft.Bot.Builder
{
    ...
    /// </example>
    /// <seealso cref="IBot"/>
    public interface IMiddlewareSlack
    {
		/// <summary>
		...
		Task OnTurn(ICommandContext context, MiddlewareSetSlack.NextDelegate next);
    }

    /// <summary>
    /// Helper class for defining middleware by using a delegate or anonymous method.
    /// </summary>
    public class AnonymousReceiveMiddleware : IMiddlewareSlack
	{
        private readonly Func<ICommandContext, MiddlewareSetSlack.NextDelegate, Task> _toCall;
        ...
        public AnonymousReceiveMiddleware(Func<ICommandContext, MiddlewareSetSlack.NextDelegate, Task> anonymousMethod)
        {
        ...
        /// <param name="next">The delegate to call to continue the bot middleware pipeline.</param>
        /// <returns>A task that represents the work queued to execute.</returns>
        public Task OnTurn(ICommandContext context, MiddlewareSetSlack.NextDelegate next)
        {
